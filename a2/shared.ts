...
export let response = (ws: WebSocket, type: string, data?: any, timeout?: number, onTimeout = (res, rej) => rej('timeout')) => new Promise((res, rej) => {
    let timeoutInterval
    let msg_out = {
...
export let message = async (ws: WebSocket, type: string) => {
